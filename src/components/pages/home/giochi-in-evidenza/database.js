...
export const boxes = [
  ...
  {
    box: <EABox variant="up" overlay="linear-gradient(90deg, #29244d, #ff4747)" links={links} boxImage="./assets/images/components/giochi-in-evidenza/f122.png" boxLogo="./assets/images/components/giochi-in-evidenza/f122-gamebox.svg" logoWidth="160px" />
  },
  {
