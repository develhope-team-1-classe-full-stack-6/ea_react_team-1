  ...
  const handleChange = (event) => {
    ...
    return (
        <FooterGrid sx={{height: {xs: 'auto', sm: 'auto', md: 'auto', lg: '280px'}, width: 1}} container>
            <Grid container xs={11} sm={11} md={11} lg={8} xl={8} justifyContent="space-between" sx={{border: '1px solid black', height: 3/4, margin: "auto", mt: {sm: "20px", lg: "10px"}, mb: {sm: "20px", lg: "0px"} ,maxWidth: "1120px !important"}}>
                <Grid item container justifyContent="center" xs={12} sm={12} md={12} lg={1} sx={{ justifyContent: {xs: "left", lg: "center"}, border: '1px solid black', height: {xs: 2/5, sm: 1/5, md: 1/5, lg: 2/5}, minHeight: "55px"}}>
                ...
                <Grid item container sx={{border: '1px solid black', height: {xs: 2/5, sm: 1/5, md: 1/5, lg: 2/5}, pl: 1, pt: {md: "0.5em", lg: 0}, m: {sm:"10px", md: "5px", lg: "0px"}}} xs={12} sm={12} md={12} lg={6}>
                    {MAIN_LINKS.map(text => <Typography item sx={{mr: "20px", maxHeight: {}}}>{text}</Typography>)}
                </Grid>
                <Grid item container justifyContent="space-between" sx={{border: '1px solid black', height: {xs: 2/5, sm: 2/5, md: 2/5, lg: 2/5}, justifyContent: {xs: "center", lg: "flex-end"}, minHeight: {sm: "150px", md: "80px", lg: "0px"}}} xs={12} sm={12} md={12} lg={5}>


                <FormControl sx={{ m: 1, minWidth: 120, width: {xs:"80%", md: "40%", lg: 120} }}>
                <Select
                value={age}
            ...
            <FormControl sx={{ m: 1, minWidth: 120, width: {xs: "80%", md: "40%", lg: 120}}}>
                ...
                <Grid item container sx={{border: '1px solid black', height: 3/5, pt: 2, pb: 2, pl: 1, ml: {sm: "10px", md: 3, lg: 9, xl: 11}}} xs={12} sm={12} md={7} lg={7} xl={5}>
                    {TC_LINKS.map(text => <Typography item sx={{fontSize: "14px", mr: "15px", wordWrap:"break-word"}}>{text}</Typography>)}
                </Grid>
                <Grid item container justifyContent="flex-end" alignItems="flex-end" sx={{border: '1px solid black', height: {md: "140px", lg: 3/5}, justifyContent: {sx: "flex-start", md: "flex-end"}}} xs={12} sm={12} md={3}>
